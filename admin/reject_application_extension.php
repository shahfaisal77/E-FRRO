    ...
    if ($result->num_rows > 0) {
        ...
        if ($currentStatus === 'rejected') {
            ...
            if ($conn->query($update_query) === TRUE) {
                ...
                echo '<script>alert("Application has been rejected. An email has been sent to the applicant."); window.location.href="new_registration_application.php";</script>';
                exit();
            } else {
...
function sendRejectionEmail($recipientEmail, $recipientName)
{
    try {
        ...
        $mail->Body = 'Dear ' . $recipientName . ',<br>Your visa application has been rejected. Please visit our FRRO office as soon as possible for further assistance.<br>Thank you.';
