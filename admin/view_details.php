...
<button id="openPathButton" class="btn btn-primary float-right" style="margin-right: 10px; margin-top: 2px;">View Files</button>
    ...
    <div class="highlight-alert float-right">
        ...
        $folderPath = '../uploads/new_registration_applications/' . $applicantRow['given_name'];
    ...
    <a href="new_registration_application.php" class="btn btn-secondary">&lt; Back to Previous Page</a>
    <h2 class="text-center mt-4">Applicant Details</h2>
