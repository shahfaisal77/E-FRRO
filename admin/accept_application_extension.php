...
foreach ($allowedExtensions as $extension) {
    $potentialImagePath = "../uploads/extension_applications/$givenName/image.$extension";
...
// Save PDF to a file
$folderName = '../accepted_applications/registration_extension/' . $givenName;
...
try {
    ...
    $mail->send();
    echo '<script>alert("Email sent successfully"); window.location.href = "registration_extension.php";</script>';
} catch (Exception $e) {
