...
?>
    ...
    <form method="post" action="mainExtensionFormSubmit.php" >
...
<div class="form-group">
    ...
    <div class="row mt-3">
        ...
        <!-- Add the remaining Arrival Details input fields here -->
         ...
         <div class="form-group">
                <h2 class="bg-primary text-white p-2">Previous Registration in India Details (if any)</h2>
                <!-- Add input fields for Previous Registration in India Details here -->
                <div class="row">
                    
                    <div class="col-md-4">
                        <label>Registration Number(Previous):</label>
